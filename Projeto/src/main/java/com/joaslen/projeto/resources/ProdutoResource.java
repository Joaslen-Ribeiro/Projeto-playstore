...
public class ProdutoResource {
	...
	public ResponseEntity<Produto> find(@PathVariable Integer id ) { // @pathvariable para saber que o id vai na url
	...
	@RequestMapping(method=RequestMethod.GET) // define o parametro da pagina mas sem obrigatoriedade
